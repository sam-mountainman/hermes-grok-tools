...
When a tool returns `error_type: usage_limit`, show the complete error and clickable SuperGrok upgrade link without rewriting or removing it. Preserve the original Grok CLI error. Do not retry automatically or silently lower reasoning effort.
